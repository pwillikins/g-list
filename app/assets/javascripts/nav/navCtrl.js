    ...
    function ($scope, Auth, $state, $mdDialog) {
      ...
      $scope.openBuildListDialog = function (ev) {
        ...
        $mdDialog.show({
          ...
          targetEvent: ev,
          locals: { data: propagatedProducts, recipeListFactory: $scope.recipeListFactory, selectedRecipes: $scope.$parent.selectedRecipes },
      ...
      function DialogController($scope, $mdDialog, data, recipeListFactory, selectedRecipes) {
        ...
        $scope.buildList = function () {
          ...
          recipeListFactory.create({recipes: selectedRecipes}).then(function () {
            $mdDialog.hide()
        ...
        $scope.createRecipeList = function() {
          recipeLists.create().then( function() {
